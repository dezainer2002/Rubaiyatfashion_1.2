    ...
    var ella = {
        ...
        init: function () {
            ...
            if(body.hasClass('template-product') ) {
                ...
                if ($('#add-to-cart-form .single-option-selector').length) {
                    this.changeSwatch('#add-to-cart-form .single-option-selector');
                }
            ...
            $('[data-product-cart-slider]').slick({
                ...
                get nextArrow() {
                    if (window.layout_style == 'layout_style_1170') {
                        ...
                        return this.nextArrow = '<button type="button" class="slick-next"><svg xmlns="http://www.w3.org/2000/svg" width="10" height="18" viewBox="0 0 10 18" fill="none">\n' +
                            '<path d="M9.49389 8.50611L1.18219 0.194424C0.907031 -0.0713231 0.468557 -0.0636932 0.202811 0.211469C-0.0564428 0.479895 -0.0564428 0.905422 0.202811 1.17381L8.02481 8.99581L0.202811 16.8178C-0.0676035 17.0883 -0.0676035 17.5267 0.202811 17.7972C0.473306 18.0676 0.911739 18.0676 1.18219 17.7972L9.49389 9.4855C9.7643 9.215 9.7643 8.77657 9.49389 8.50611Z" fill="#181818"/>\n' +
                            '</svg></button>';
                    }
                },
                get prevArrow() {
                                            ...
                                            productGrid.slick({
                                                ...
                                                get nextArrow() {
                                                    if (window.layout_style == 'layout_style_1170') {
                                                        ...
                                                        return this.nextArrow = '<button type="button" class="slick-next">' +
        ...
        doUpdateDropdownCart: function (cart) {
            var template = '<li class="item" id="cart-item-{ID}" data-product-id="{ID}">' +
                '<a href="{URL}" class="product-image"><img src="{IMAGE}" alt="{TITLE}"></a>' +
                '<div class="product-details">' +
                '<a class="product-name" href="{URL}">{TITLE}</a>' +
                '<div class="option"><small>{VARIANT}</small>' +
                '<a href="javascript:void(0);" class="product-details__edit" data-cart-edit aria-label="link" data-url="{URL}&view=cart_edit" data-id="{ID}" data-quantity="{QUANTITY}"><svg xmlns="http://www.w3.org/2000/svg" fill="#000000" viewBox="0 0 48 48" width="144px" height="144px"><path d="M 10.5 6 C 7.468 6 5 8.468 5 11.5 L 5 36 C 5 39.309 7.691 42 11 42 L 22.605469 42 C 22.858469 41.042 23.225516 39.759 23.728516 38 L 11 38 C 9.897 38 9 37.103 9 36 L 9 16 L 39 16 L 39 22.521484 C 39.427 22.340484 39.8615 22.188422 40.3125 22.107422 C 40.7065 22.036422 41.102859 21.992953 41.505859 22.001953 C 42.015859 22.001953 42.515 22.067641 43 22.181641 L 43 11.5 C 43 8.468 40.532 6 37.5 6 L 10.5 6 z M 13.5 20 A 1.50015 1.50015 0 1 0 13.5 23 L 15.5 23 A 1.50015 1.50015 0 1 0 15.5 20 L 13.5 20 z M 21.5 20 C 20.672 20 20 20.671 20 21.5 C 20 22.329 20.672 23 21.5 23 L 34.5 23 C 35.328 23 36 22.329 36 21.5 C 36 20.671 35.328 20 34.5 20 L 21.5 20 z M 41.498047 24 C 41.224047 24.001 40.946969 24.025172 40.667969 24.076172 C 39.783969 24.235172 38.939563 24.696156 38.226562 25.410156 L 26.427734 37.208984 C 26.070734 37.565984 25.807969 38.011141 25.667969 38.494141 L 24.097656 43.974609 C 24.025656 44.164609 23.993 44.365406 24 44.566406 C 24.013 44.929406 24.155594 45.288406 24.433594 45.566406 C 24.710594 45.843406 25.067688 45.986 25.429688 46 C 25.630688 46.007 25.834391 45.975344 26.025391 45.902344 L 31.505859 44.332031 C 31.988859 44.192031 32.431062 43.930266 32.789062 43.572266 L 44.589844 31.773438 C 45.303844 31.060437 45.764828 30.216031 45.923828 29.332031 C 45.973828 29.053031 45.997047 28.775953 45.998047 28.501953 C 46.001047 27.307953 45.540687 26.179312 44.679688 25.320312 C 43.820687 24.460313 42.692047 23.998 41.498047 24 z M 13.5 26 A 1.50015 1.50015 0 1 0 13.5 29 L 15.5 29 A 1.50015 1.50015 0 1 0 15.5 26 L 13.5 26 z M 21.5 26 C 20.672 26 20 26.671 20 27.5 C 20 28.329 20.672 29 21.5 29 L 31.808594 29 L 34.779297 26.027344 C 34.688297 26.010344 34.596 26 34.5 26 L 21.5 26 z M 13.5 32 A 1.50015 1.50015 0 1 0 13.5 35 L 15.5 35 A 1.50015 1.50015 0 1 0 15.5 32 L 13.5 32 z M 21.5 32 C 20.672 32 20 32.671 20 33.5 C 20 34.329 20.672 35 21.5 35 L 25.808594 35 L 28.808594 32 L 21.5 32 z"/></svg></a>' +
                '</div>' +
                '<div class="cart-collateral">' +
                '<span class="price">{PRICE}</span>' +
                '</div>' +
                '<div class="quantity"><input class="item-quantity" name="quantity" id="updates_{ID}" data-qtt-id1="quantity_{ID}" value="{QUANTITY}" type="number" /><span class="error-message-input"></span></div></div><a href="javascript:void(0)" title="Remove This Item" class="btn-remove"><svg aria-hidden="true" data-prefix="fal" data-icon="times" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" class="svg-inline--fa fa-times fa-w-10 fa-2x"><path fill="currentColor" d="M193.94 256L296.5 153.44l21.15-21.15c3.12-3.12 3.12-8.19 0-11.31l-22.63-22.63c-3.12-3.12-8.19-3.12-11.31 0L160 222.06 36.29 98.34c-3.12-3.12-8.19-3.12-11.31 0L2.34 120.97c-3.12 3.12-3.12 8.19 0 11.31L126.06 256 2.34 379.71c-3.12 3.12-3.12 8.19 0 11.31l22.63 22.63c3.12 3.12 8.19 3.12 11.31 0L160 289.94 262.56 392.5l21.15 21.15c3.12 3.12 8.19 3.12 11.31 0l22.63-22.63c3.12-3.12 3.12-8.19 0-11.31L193.94 256z" class=""></path></svg></a></li>';
        ...
        checkStatusSwatchQs: function (productItem) {
            if (window.use_color_swatch) {
                ...
                productItem.find('.product-top').find('.selector-wrapper:not(.option-color)').each(function(){
        ...
        linkClickToggleSubMenuMobile: function (mainMenu) {
            ...
            if (iconDropdown.length) {
                ...
                body.off('click.closeMenu').on('click.closeMenu', '.sub-menu-mobile .menu-mb-title', function (e) {
                    e.preventDefault();
                    e.stopPropagation();
        ...
        ajaxMapData: function (data) {
            var curCollTemplate = $('.collection-template'),
                ...
                curDiffToolbar = curCollTemplate.find('.toolbar'),
                ...
                newDiffToolbar = newCollTemplate.find('.toolbar');
            ...
            curDiffToolbar.replaceWith(newDiffToolbar);
        ...
        initToggleWidgetTitleSidebarFilter: function () {
            ...
            if(win.innerWidth() < 1200) {
                ...
                if (win.innerWidth() < 992) {
                    ...
                    $('.padding').appendTo('.toolbar .column-right');
                }
            ...
            doc.off('click.addToCart', btnAddToCartSlt).on('click.addToCart', btnAddToCartSlt, function (e) {
                ...
                if (self.attr('disabled') !== "disabled") {
                    ...
                    var form = productItem.find('form[action="/cart/add"]'),
                        handle = window.router + productItem.find('.product-grid-image').data('collections-related') || sectionsProduct.data('collections-related');
        ...
        initGroupedAddToCart: function() {
            ...
            doc.off('click.GroupedAddToCart', btnAddToCartSlt).on('click.GroupedAddToCart', btnAddToCartSlt, function (e) {
                ...
                if (self.attr('disabled') !== "disabled") {
                    ...
                    var form = productItem.find('form[action="/cart/add"]'),
                        handle = window.router + sectionsProduct.data('collections-related'),
            ...
            $.ajax({
                ...
                error: function (xhr) {
                    ...
                    if(Shopify.locale === 'ar'){
                        $('.ajax-error-message').text('كمية غير كافية في المخزون');
                    }
                    ella.showModal('.ajax-error-modal');
                },
        ...
        initQuickView: function () {
            body.off('click.initQuickView', '.search-product,.quickview-button').on('click.initQuickView', '.search-product,.quickview-button', function (e) {
                e.preventDefault();
                e.stopPropagation();
        ...
        initBundleProducts: function() {
            ...
            var bundleSlider = function() {
                if(bundleImagesSlide.length && bundleImagesSlide.not('.slick-initialized')) {
                    if ((window.layout_style == 'layout_style_1170') || (window.layout_style == 'layout_style_fullwidth')) {
                        if(window.product_style == 'skin_1') {
                            var images = 3;
                        } else {
            ...
            replaceDiscountRate();
            bundleSlider();
            if(($('.layout_style_1170 ').length) || ($('.layout_style_fullwidth.product_layout_skin_1').length) ){
        ...
        hide_filter: function(){
            $('select.list-tags').each(function (){
